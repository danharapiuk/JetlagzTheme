...
<div class="wrapper">
    ...
    <div class="shop-filters" id="shop-filters">
        ...
        <div class="filters-content">
            ...
            <!-- Kolory -->
            <?php
            $color_groups = function_exists('jetlagz_get_color_filter_groups') ? jetlagz_get_color_filter_groups(true) : array();
            ...
            ?>
                <div class="filter-group">
                    ...
                    <div class="filter-options filter-colors">
                        <?php
                        $selected_colors = function_exists('jetlagz_get_selected_color_filters') ? jetlagz_get_selected_color_filters() : array();
                        foreach ($color_groups as $group) :
                        ?>
                            <label class="filter-color-button" title="<?php echo esc_attr($group['label']); ?>">
                                <input type="checkbox" name="pa_kolor[]" value="<?php echo esc_attr($group['key']); ?>"
                                    <?php echo in_array($group['key'], $selected_colors, true) ? 'checked' : ''; ?>>
                                <span class="color-swatch" style="background-color: <?php echo esc_attr($group['swatch']); ?>"></span>
                                <span class="color-name"><?php echo esc_html($group['label']); ?></span>
                            </label>
                        <?php endforeach; ?>
                    </div>
                </div>
